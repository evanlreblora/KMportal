        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Policy Brief Table</h3>
            ...
            <div class="card-body table-responsive p-0">
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  <tr v-for="(policybrief, index) in policybriefs.data" :key="policybrief.id">
                    <td :title="policybrief.id">
                      {{ page + index + 1 }}
                    </td>
                    <td>{{ policybrief.filename }}</td>
                    <td>{{ policybrief.desc }}</td>
                    <td>{{ policybrief.unit }}</td>
                    <td>
                      {{ policybrief.type }}
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      <a href="#" @click.prevent="deleteUser(policybrief)" title="Remove">
...
export default {
  ...
  methods: {
    ...
    async getUsers(page = 1) {
      ...
      try {
        const policybriefs = await axios.get(`/api/policybriefs/?page=${page}`);
        this.policybriefs = policybriefs.data;
      } catch (error) {
    ...
    async createUser() {
      ...
      try {
        await this.form.put(`/api/policybriefs/${this.form.id}`);
        $("#userModal").modal("hide");
