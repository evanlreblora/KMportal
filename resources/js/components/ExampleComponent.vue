...
<script>
    export default {
        ...
        methods: {
            ...
            this.form.post('api/policybriefs')
               .then(()=>{
            ...
            //Pagination
            getResults(page = 1) {
                  axios.get('api/policybriefs?page=' + page)
                    .then(response => {
            ...
            UpdatePhoto(){
              this.form.put('api/policybriefs/'+this.form.id)
               .then(()=>{
            ...
            deletePhoto(id){
              ...
              if (result.value) {
                ...
                this.form.delete('api/policybriefs/'+id)
                    .then((response)=> {
                            Swal.fire(
                              'Deleted!',
