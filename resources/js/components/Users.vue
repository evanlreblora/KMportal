              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  <tr v-for="(user, index) in users.data" :key="user.id">
                    ...
                    <td>{{ user.unit }}</td>
                    <td>
                      <span class="tag tag-success">{{ user.type | capital }}</span>
                    </td>
                    <td>
                      {{ user.created_at | customDate }}
                    </td>
                    <td>
                      <a href="#" title="Edit" @click="openUserModal(user)">
                        <i class="fa fa-edit indigo"></i>
                      </a>
                      <span class="yellow">/</span>
                      <a href="#" @click.prevent="deleteUser(user)" title="Remove">
  ...
  methods: {
    ...
    async updateUser() {
      ...
      try {
        ...
        $("#userModal").modal("hide");
        Swal.fire("Updated!", `User ${this.form.name} is updated`, "success");
        this.$Progress.finish();
        ...
        this.$Progress.fail();
        Swal.fire("Failed!", `User ${this.form.name} cannot be updated`, "error");
        console.log(error);
      }
    },
